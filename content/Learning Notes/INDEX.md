...
| 日期 | 主題 | 難度 | 領域 | 互動工具 |
|---|---|---|---|---|
| 2026-05-19 | [[2026-05-19-學習-生成時專業化 Agent 合成系統\|生成時專業化（Agent 合成系統）]] | 進階 | LLM Serving / Code Agent | — |
| 2026-05-19 | [[2026-05-19-學習-混合模型整合與 Token 路由統一視角\|混合模型整合（ME）與 Token 路由統一]] | 中階 | LLM 整合 / MoE | — |
| 2026-05-19 | [[2026-05-19-學習-多目標賽局論 RL 與永續 AI 調度\|多目標賽局論 RL 與永續 AI 調度（MARLIN）]] | 進階 | Multi-Agent RL / 永續 AI | — |
| 2026-05-18 | [[2026-05-18-學習-深度等價模型與固定點 LLM\|深度等價模型（DEQ）與 ELMs]] | 進階 | 模型壓縮 / 固定點 | — |
| 2026-05-18 | [[2026-05-18-學習-概念吸引子與迭代函數系統\|概念吸引子與迭代函數系統]] | 進階 | 動態系統 / LLM 表示 | — |
| 2026-05-18 | [[2026-05-18-學習-GraphBit DAG Agent 編排架構\|GraphBit DAG Agent 編排]] | 中階 | Agent 編排 / Rust 系統 | — |
...
### 模型架構（怎麼把模型蓋大、蓋好）
- [[2026-05-18-學習-深度等價模型與固定點 LLM|深度等價模型（DEQ）與 ELMs]] — ICLR 2026，把多層 Transformer 折成「單層 + 迭代到收斂」、剪 28% 參數保 99% 精度
- [[2026-05-18-學習-概念吸引子與迭代函數系統|概念吸引子與迭代函數系統]] — ICLR 2026，把 LLM 視為動態系統的收縮映射，免訓練的翻譯/抗幻覺/護欄
...
- [[2026-05-19-學習-混合模型整合與 Token 路由統一視角|混合模型整合（ME）與 Token 路由統一]] — ICML 2026 Spotlight，把多模型整合改寫為混合模型抽樣，加速 1.78x-2.68x
- [[2026-05-16-學習-DFlash 區塊擴散推測解碼|DFlash：區塊擴散推測解碼]] — 以擴散模型替換自回歸草稿模型，6 倍無損加速

### LLM 系統 / 基礎設施（怎麼讓 LLM 部署更高效、更永續）
- [[2026-05-19-學習-生成時專業化 Agent 合成系統|生成時專業化：Agent 合成 LLM Serving 系統]] — VibeServe 用兩層 Agent 迴圈自動合成客製 stack，非標準場景比 vLLM 快 1.4x-2.3x
- [[2026-05-19-學習-多目標賽局論 RL 與永續 AI 調度|多目標賽局論 RL 與永續 AI 調度（MARLIN）]] — Stackelberg 賽局結構協調延遲/碳排/用水/成本四目標，碳排降 33%、用水降 43%
- [[2026-05-18-學習-GraphBit DAG Agent 編排架構|GraphBit DAG Agent 編排]] — Rust 引擎 + DAG 編排，GAIA 67.6% 精度，零框架幻覺
...
- [[2026-05-19-學習-混合模型整合與 Token 路由統一視角|混合模型整合（ME）與 Token 路由統一]]
- [[2026-05-18-學習-GraphBit DAG Agent 編排架構|GraphBit DAG Agent 編排]]
...
### 進階（需要強數學或工程背景）
- [[2026-05-19-學習-生成時專業化 Agent 合成系統|生成時專業化：Agent 合成 LLM Serving 系統]] — 多代理迴圈 + 程式合成 + 系統設計搜索
- [[2026-05-19-學習-多目標賽局論 RL 與永續 AI 調度|多目標賽局論 RL 與永續 AI 調度（MARLIN）]] — Stackelberg 賽局 + Multi-Agent RL + Nash 均衡
- [[2026-05-18-學習-深度等價模型與固定點 LLM|深度等價模型（DEQ）與 ELMs]] — 固定點求解、Broyden 方法、隱式微分
- [[2026-05-18-學習-概念吸引子與迭代函數系統|概念吸引子與迭代函數系統]] — 動態系統理論、收縮映射、IFS
